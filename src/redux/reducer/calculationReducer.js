...
// const INITIAL_STATE = {LN:[], viewResult:[],  lastOpr:'',currentNum:'' ,lastNum:'' , mode:'NUM'}
...
//                 if(draft.mode==='OPR' && draft.lastNum==='') {  
//                     draft.lastNum=parseFloat(draft.LN.join("")); //use array to float **********
//                     draft.LN.length=0;
//                     draft.mode='OPR';
//                 }
//                 else if(draft.mode==='OPR' && draft.lastNum!==''){ //lastNum not empty, then click new numbers 
...
//                     // draft={...draft, Result: draft.lastNum,  logic: action.Num, mode:'NUM'}
//                 }
...
//                 //click 'c' or 'x' button draft convert to initialise draft
...
//                             Expr=draft.lastNum + '=';
//                         }
//                     // draft.expression.push(Expr);
//                     draft.currentNum='';
//                     // draft.result.push(Result.toString());
...
//                     draft={lastNum:Result,  lastOpr:LastOpr}
                
//                     return 

//                 }
//                 //Result add to draft lastNum 
//                 draft.lastNum=draft.Result

                
//                 if(draft.lastOpr==='' && action.Opr!=='C'){
//                     draft={lastOpr:action.Opr, mode: action.mode}
//                     return 
//                 }
//                 return ;
...
//             draft.lastOpr='';
//             draft={Result:action.res, lastNum:action.res, mode:'OPR'};
//             return 
